...
<html>
  ...
  <body background="back2.jpg">
       ...
       <h1>New York Health Care System  </h1>
...
<img src="log.jpg" height="60%" width="100%" />
	...
	<form name="form1" method="post" action="action/do_login.jsp" onSubmit="return checkInput()">
		<table border="0" align="center">
			...
			<tr>
				...
				<td><select name="urole">
						...
						<option value="e_users">admin</option>
				</select>
				</td>
			</tr>
			<tr>
