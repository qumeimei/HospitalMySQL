...
String sql_format = "select E.name, R.p_date, P.p_record from e_prescription R,e_users E,e_patient P where R.d_id='%s'and R.p_id=E.users_id and P.p_id= R.p_id";
...
<html>
  ...
  <body>
	...
	<div id="main">
		...
		<div id="opt_area">
		<H1>Your patient and Prescription Date</H1>
		<br>
<TABLE>
<tr>
<td>PatientName</td><td>Date</td><td>illnessRecord</td>
</tr>
<tr>
...
rs.getDate("p_date") + "</td><td>" +rs.getString("p_record") + "</td>");
out.print("</tr>");
}
} else {
out.print(error_msg);
