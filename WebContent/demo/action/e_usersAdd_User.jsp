...
<html>
  <head>
    ...
    <title>My JSP 'e_usersAdd_User.jsp' starting page</title>
  ...
  <script type="text/javascript">
		...
		function checkInput(){
			...
			var oemail = document.getElementById("cemail");
			var orole = document.getElementById("crole")
...
<img src="log.jpg" height="60%" width="100%" />
    ...
    <form name="form1" method="post" action="e_users_do_add.jsp" onsubmit="return checkInput()">
    	<input type="hidden" name="uname" value="<%=request.getParameter("uname")%>" /> 
		<input type="hidden" name="pwd" value="<%=request.getParameter("pwd")%>" />
		<input type="hidden" name="urole" value="<%=request.getParameter("urole")%>"/>
		<table border="0" align="center">
			...
			<tr>
				<td>Email:</td>
				<td><input type="text" name="email" id="cemail"></td>
			</tr>
				<tr>
				<td>Role</td>
				<td><select name="crole" id="crole">
