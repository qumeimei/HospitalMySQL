...
String sql_format = "select E.name, E.gender, E.birthday,P.p_record from r_service R,e_users E,e_patient P where R.n_id='%s'and R.p_id=E.users_id and P.p_id= R.p_id";
...
<html>
  ...
  <body>
	...
	<div id="main">
		...
		<H1>Your patient and Service Period</H1>
		<br>

<TABLE>
<tr>
<td>PatientName</td><td>Gender</td><td>Birthday</td><td>IllnessRecord</td>
</tr>
<tr>
