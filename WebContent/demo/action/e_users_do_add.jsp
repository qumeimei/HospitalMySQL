...
<%
	...
	try {
		...
		String sql3 = null;
		if(crole.equals("e_patient")){
			sql3 = "insert into "+crole+"(p_id,p_ssn) values("+id+",100000000)";
		}else{
		sql3 = "insert into "+crole+"(users_id,ssn) values("+id+",100000000)";
		}
		...
		if (affected > 0) {
			if(affected2>0){				
				String path = "../admin/welcome.jsp?uname="+uname+"&pwd="+uname+"&urole="+urole;
