...
String sql_format = "select R.purchase_id, E.i_price,E.i_percent from r_purchase R, e_insurance E where R.p_id='%s'and R.i_id =E.i_id";
...
<TABLE>
<tr>
<td>Purchase_ID</td><td>Price</td><td>Percent</td>
</tr>
<tr>
...
while(rs.next()) {
out.print("<tr>");
out.print("<td>" + rs.getInt("purchase_id") + "</td><td>" +
rs.getDouble("i_price") + "</td>" +
