...
String sql_format = "select E.name, R.s_from, R.s_to from r_service R,e_users E where R.n_id='%s'and R.p_id=E.users_id";
...
<TABLE>
<tr>
<td>PatientName</td><td>From</td><td>To</td>
</tr>
<tr>
